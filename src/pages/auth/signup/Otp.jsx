...
//           className="w-full bg-primary text-secondary block text-center font-medium py-3 rounded-full hover:bg-green-500 transition-colors mb-4"
//         >
//           Verify OTP
//         </Link>
...
const Otp = () => {
    ...
    //     // If verification is successful, navigate to personal details
      ...
      <div className="flex min-h-screen bg-gray-50 md:p-8 p-4 space-x-11 item bg-[#f6fceb]">
        <div className="lg:w-[50%] pt-[8rem]">
          <div className="w- lg:pl-[8rem]">
            ...
            <div className="text-sm text-gray-600">
              Already have an account? 
              <Link to="/login" className="text-green-600 hover:text-green-700 ml-1">Log in</Link>
            </div>
