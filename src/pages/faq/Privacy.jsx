      ...
      <div className="min-h-screen bg-[#F6FCEB] lg:p-6 lg:pt-[8rem] px-4 pt-[6rem]">
        <div className="max-w-3xl mx-auto shadow rounded px-6 py-10 text-gray-800 bg-white">
          ...
          <ul className="list-disc pl-6 mb-6">
            ...
            <li>
              <span className="font-medium">Service Data:</span> Skills,
              transactions, profile activity.
            </li>
            <li>
              <span className="font-medium">Payment Info:</span> Processed
          ...
          <p className="mb-6">
            We use cookies for site performance and analytics. You may disable
          ...
          <ul className="mb-2">
            <li>
              ...
              <a
                href="mailto:support@skillovia.com"
            ...
            <li>
              <span className="font-medium">Address:</span> [Insert registered
              address]
            </li>
            <li>
              <span className="font-medium">Phone:</span> [Insert contact
              number]
            </li>
          </ul>
        </div>
