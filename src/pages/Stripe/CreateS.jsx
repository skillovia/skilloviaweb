...
import { FiCreditCard, FiDollarSign, FiCheck, FiX, FiLoader, FiExternalLink } from 'react-icons/fi';
      ...
      <div className="max-w-md mx-auto">
              ...
              <>
                <div className="mb-8">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-600">Receive payments directly to your bank account</span>
                    </li>
                    <li className="flex items-start">
                      <FiCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    ...
                    <li className="flex items-start">
                      <FiCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                      <span className="text-gray-600">Detailed transaction reporting</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mb-6 border border-gray-200">
                  <p className="text-sm text-gray-600">
                    ...
                    <a href="https://stripe.com/tos" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:text-indigo-500"> 
                      Terms of Service
                    </a> and 
                    <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:text-indigo-500">
                      {' '}Privacy Policy
                    </a>.
                  </p>
                </div>
            ...
            {loading && (
              <div className="text-center py-10">
                ...
                <p className="text-gray-600">
                  {step === 'initial' ? 'Creating your Stripe account...' : 
                   step === 'account-created' ? 'Generating onboarding link...' : 
                   'Processing...'}
                </p>
              </div>
            )}
                  ...
                  {stripeAccount && (
                    <>
                      <p className="text-xs text-gray-600 mb-1">
                        <span className="font-medium">Account ID:</span> {stripeAccount.stripe_account_id}
                      </p>
                      <p className="text-xs text-gray-600 mb-1">
                        <span className="font-medium">Created:</span> {new Date(stripeAccount.created_at).toLocaleString()}
                      </p>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500">
            Need help? <a href="/support" className="text-secondary hover:text-indigo-500">Contact Support</a>
          </p>
        </div>
      </div>
    </div>
